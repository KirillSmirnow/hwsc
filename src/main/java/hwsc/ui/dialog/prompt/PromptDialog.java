...
public class PromptDialog extends AbstractDialog {
    ...
    public PromptDialog(String title, String value, String valueCaption,
                        String confirmButtonCaption, PromptListener promptListener) {
        super(title);
        setContent(new PromptDialogLayout(valueCaption, value, confirmButtonCaption,
                "Cancel", promptListener, this));
    }
}
