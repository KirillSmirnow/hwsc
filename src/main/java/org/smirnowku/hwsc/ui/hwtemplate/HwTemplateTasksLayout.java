...
public class HwTemplateTasksLayout extends HorizontalSplitPanel {
    ...
    public void setListeners(AssignHwListener assignHwListener, EditHwTemplateListener editHwTemplateListener,
                             ...
                             EditTaskListener editTaskListener, DeleteTaskListener deleteTaskListener) {
        hwTemplateSidePanel.setListeners(assignHwListener, editHwTemplateListener, deleteHwTemplateListener,
